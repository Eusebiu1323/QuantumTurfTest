package org.quantumturf.scheduler;
...
public class SchedulerTest extends BaseTest {
    ...
    @Test
    public void dateButtonTest() {
        loginPage.performLogin();
        mainPage.clickOnSchedulerTab();
        schedulerPage.setDateButton();
       schedulerPage.startingDateButton();
       schedulerPage.selectStartDateButton();
       schedulerPage.endingDateButton();
       schedulerPage.selectEndDateButton();
    }
}
